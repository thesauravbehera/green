...
export const MobileDashboard = () => {
  ...
  const quickActions = [
    { icon: Camera, label: 'Scan', color: 'from-blue-500 to-cyan-500', action: '/ai' },
    { icon: Plus, label: 'Add Plant', color: 'from-green-500 to-emerald-500', action: '/garden' },
