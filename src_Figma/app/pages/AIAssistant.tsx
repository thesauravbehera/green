...
export const AIAssistant = () => {
  ...
  const messages = [
    ...
    },
    {
      id: 2,
      type: 'user',
      text: 'My basil leaves are turning yellow. What should I do?',
      time: '10:32 AM'
    },
    {
      id: 3,
      type: 'ai',
      text: 'Yellow basil leaves can be caused by several factors. Let me help you diagnose:',
      time: '10:32 AM',
      diagnosis: {
        possibleCauses: [
          { name: 'Overwatering', probability: 70, icon: Droplets },
          { name: 'Nutrient Deficiency', probability: 20, icon: Sprout },
          { name: 'Too Much Sun', probability: 10, icon: Sun }
        ],
        recommendation: 'Based on typical symptoms, I recommend checking soil moisture. Let the soil dry between waterings. Consider adding nitrogen-rich fertilizer.'
      }
    }
  ];
